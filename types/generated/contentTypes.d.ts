...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Booking requests between users for skill exchanges.';
    displayName: 'Booking';
    pluralName: 'bookings';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    durationHours: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking.booking'
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Skill categories for browsing and filtering.';
...
export interface ApiNotificationNotification
  ...
  info: {
    description: 'Simple UI notifications shown to users.';
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Static content pages like FAQ, About, and Policies.';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Public profile information linked to a user.';
    displayName: 'Profile';
    pluralName: 'profiles';
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Abuse or misuse reports for moderation.';
    displayName: 'Report';
    pluralName: 'reports';
    singularName: 'report';
  };
  ...
  attributes: {
    ...
    reason: Schema.Attribute.Enumeration<
      ['spam', 'abuse', 'fraud', 'inappropriate', 'other']
    > &
      Schema.Attribute.Required &
    ...
    skill: Schema.Attribute.Relation<'manyToOne', 'api::skill.skill'> &
      Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<['open', 'resolved', 'dismissed']> &
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Ratings and reviews after a completed exchange.';
    displayName: 'Review';
    pluralName: 'reviews';
    singularName: 'review';
  };
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Skill offers and requests created by community users.';
    displayName: 'Skill';
    pluralName: 'skills';
    singularName: 'skill';
  };
  ...
  attributes: {
    ...
    isRemote: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    skillType: Schema.Attribute.Enumeration<['offer', 'request']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'offer'>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    type: Schema.Attribute.Enumeration<['Editor', 'User']> &
      Schema.Attribute.Required &
